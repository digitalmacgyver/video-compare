...
No-reference quality metrics pipeline for comparing analog video capture devices. All clips are ProRes 422 HQ, 576x436, 10-bit yuv422p10le.
...
# Normalize a set of clips (auto-detects frame rate)
...
- Frame rate is auto-detected via ffprobe (supports 24000/1001, 60000/1001, etc.)
